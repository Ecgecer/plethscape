...
const chapters = [
  ...
  },
  {
    ...
    body: "Tap another wearable. The same rhythm takes on a different shape.",
  },
];
      ...
      {p.mode === "explore" ? (
        <>
          <span className="experience-eyebrow">
            <Sparkle size={15} /> YOUR FIRST DISCOVERY
          </span>
          <div
          ...
          <div className="journey-copy" aria-live="polite">
            <h2>
              {phase < 0 ? "Meet the signal within." : chapters[phase].title}
            </h2>
            <p>
              {phase < 0
                ? "A heartbeat becomes a pulse. A little light turns it into a signal. Follow its journey."
                : chapters[phase].body}
            </p>
          </div>
          {phase >= 0 && (
