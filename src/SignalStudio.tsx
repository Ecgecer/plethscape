...
export default function SignalStudio(p: Props) {
  ...
  return (
    <aside
      className="signal-panel studio-panel"
    ...
    >
      <div className="studio-intro">
        ...
        <p>Move through time. Connect the heart, the tissue and the pulse.</p>
      </div>
      <section className="studio-time" aria-label="Heartbeat playback">
        ...
        <p className="studio-small">
          One pulse isolated from its neighbors. The replay includes travel to
          the most distant site.
        </p>
      </section>
      <section
